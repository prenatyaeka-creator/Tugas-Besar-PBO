-- TaskMate MySQL Import (schema + schema only (no seed)
-- Safe re-import: drops & recreates database to avoid FK errors
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;
DROP DATABASE IF EXISTS `db_taskmate`;
CREATE DATABASE `db_taskmate` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `db_taskmate`;
