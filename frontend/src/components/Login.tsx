      ...
      <div className="w-full max-w-md relative z-10 animate-scale-in">
        <div className="text-center mb-8">
          ...
          <div className="flex justify-between items-start mb-6 animate-slide-down">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={toggleTheme}
                className="btn-luxury p-3 rounded-xl text-white/90 hover:text-white transition-all smooth-hover hover:scale-110 shadow-2xl"
        ...
        <Card className="card-premium border-white/60 dark:border-white/20 shadow-2xl backdrop-blur-2xl animate-slide-up">
          <CardHeader className="p-8">
            <CardTitle className="gradient-text text-3xl">{t('auth.login')}</CardTitle>
            <CardDescription className="text-lg mt-2">{t('auth.loginDesc')}</CardDescription>
          </CardHeader>
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full btn-gradient text-white border-0 shadow-2xl hover-lift animate-slide-up h-12 text-base rounded-xl" style={{animationDelay: '0.3s'}}>
                {t('auth.login')}
              </Button>
</form>
